    ...
    isAuth && (
        ...
        screenOptions={({ route }) => ({
          tabBarIcon: ({ focused, color, size }) => {
            ...
            if (route.name === "NewPost") {
              return (
                <View style={buttonStyles}>
                  <AddIcon color={focused ? "white" : "#212121CC"} />
                </View>
              );
            } else if (route.name === "Profile") {
              return (
                <View style={buttonStyles}>
                  <ProfileIcon color={focused ? "white" : "#212121CC"} />
                </View>
              );
            }
          },
      ...
      >
        <Tabs.Screen
          ...
          options={optionsFn("Публікації", true)}
        />
        <Tabs.Screen
          name="NewPost"
          component={CreatePostsScreen}
          options={{
            ...optionsFn("Створити публікацію", true, true),
        ...
        <Tabs.Screen
          ...
          options={optionsFn("Профіль", false)}
        />
      </Tabs.Navigator>
    )
  );
